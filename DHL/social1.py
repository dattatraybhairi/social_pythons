...
broker = "earthron.vacustech.in"#"dhl.vacustech.in"
port = 1883
topic = "earthtracking"#"dhltracking"
            ...
            if byteBufferLength > frame_size:
                ...
                for loc in possible_locs:
                    if loc > (frame_size - 1):
                        ...
                        try:
                            print("Sending params data to teh ZM")
                            ...
                            print("Params data successfully sent to the ZM")
...
def processDataFrame(data_array):
    ...
    for pair in split_data_array:
        if pair[1]:
            ...
            db_payload.append({
                "id1": "5a-c2-15-b1" + "-" + "{0:0{1}x}".format(pair[0], 2) + "-" + "{0:0{1}x}".format(pair[1], 2),
                "id2": "5a-c2-15-b1" + "-" + "{0:0{1}x}".format(pair[2], 2) + "-" + "{0:0{1}x}".format(pair[3], 2),
